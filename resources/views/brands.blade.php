    ...
    <div class="row justify-content-center">
        <div class="card text-bg-dark">
            ...
            <div class="card-img-overlay text-center">
              <h1 class="card-title" style="margin-top: 0.7vw; font-size:7vw">{{ __('static_text.brands.title') }}</h1>
            </div>
          </div>
          <div class="container text-center mt-3">
            <p style="font-size: 2vw">{{ __('static_text.brands.text') }}</p>
          </div>
          <div class="container text-center mt-3">
                    ...
                    <div class="col mb-2">
                        <div class="card" style="height:23rem">
                            ...
                            <div class="card-footer">
                                <a href="/brands/{{ $brand->id }}" class="btn btn-primary">{{ __('static_text.brands.view') }}</a>
                              </div>
                        </div>
                    </div>
                @endforeach
